...
settings:
  ...
  graph_direction: 'rtl' # which way fill the graph - 'ltr' or 'rtl'

bars_colors: [
  {min: -1, max: 0,    color: 'rgba(0,0,0,.6)'} # unavailable
  {min: 0,  max: 10,    color: '#1e9efa'}
  {min: 10,  max: 30,   color: '#74fc55'}
  {min: 30, max: 60,   color: '#ffc154'}
  {min: 60, max: 100,   color: '#ff9754'}
  {min: 100, max: 9999, color: '#ff6254'}
]
